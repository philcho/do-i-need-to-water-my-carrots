...
var getPrecipData = function(day, latLong, callback) {
  var options = {
    method: 'GET',
    uri: `https://api.darksky.net/forecast/${DARKSKY_KEY}/${latLong},${day}T00:00:00-8000?exclude=currently,hourly,flags`
  };
